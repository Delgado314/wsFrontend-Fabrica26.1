...
export default function Catalog() {
    ...
    const { characters, currentPage, hasNextPage, hasPrevPage, goToPage } = RickAndMorty();
        ...
        <section className="flex flex-col items-center gap-7">
            ...
            <div className="flex justify-center items-center gap-7 mt-4 pb-10">
                <button
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-full bg-zinc-600 text-white hover:bg-blue-600 disabled:opacity-20 disabled:hover:bg-zinc-800 cursor-pointer"
                ><ArrowLeft /></button>
